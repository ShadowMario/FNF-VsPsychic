...
class FreeplayState extends MusicBeatState
{
	...
	public static var coolColors:Array<Int> = [-7179779, -7179779, -14535868, -7072173, -223529, -6237697, -34625, -11009901];
...
class SongMetadata
{
	...
	public function new(song:String, week:Int, songCharacter:String)
	{
		...
		if(week == -99) { //Psychic week uses the last value on the array
